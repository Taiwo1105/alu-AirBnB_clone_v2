...
<html lang=\"en\">
    ...
    <body style=\"margin: 0px; padding: 0px;\">
        <header style=\"height: 65px; width: 100%; background-color: #FF0000\">
        </header>

        <footer style=\"position: absolute; left: 0; bottom: 0; height: 50px; width: 100%; background-color: #00FF00; text-align: center; overflow: hidden;\">
